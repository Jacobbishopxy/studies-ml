# @file:	download_mnist_dataset.py
# @author:	Jacob Xie
# @date:	2023/03/10 18:10:59 Friday
# @brief:	https://gist.github.com/goldsborough/6dd52a5e01ed73a642c1e772084bcd03
...
def unzip(zipped_path, quiet):
    ...
    with gzip.open(zipped_path, "rb") as zipped_file:
        with open(unzipped_path, "wb") as unzipped_file:
            unzipped_file.write(zipped_file.read())  # type: ignore
            if not quiet:
