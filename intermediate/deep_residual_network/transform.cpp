 ...
 * @file:	transform.cpp
 * @author:	Jacob Xie
 * @date:	2023/04/13 20:44:23 Thursday
 * @brief:
 **/
...
ConstantPad::ConstantPad(const std::vector<int64_t>& padding, torch::Scalar value) : padding_(padding), value_(value) {}

ConstantPad::ConstantPad(int64_t padding, torch::Scalar value) : padding_(4, padding), value_(value) {}
