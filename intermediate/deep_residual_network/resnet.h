 ...
 * @file:		resnet.h
 * @author:	Jacob Xie
 * @date:		2023/04/10 23:26:54 Monday
 * @brief:
 *
 * https://github.com/prabhuomkar/pytorch-cpp/blob/master/tutorials/intermediate/deep_residual_network/include/resnet.h
 **/
...
ResNetImpl<Block>::ResNetImpl(
    const std::array<int64_t, 3>& layers,
    int64_t num_classes
...
// 包装进 ModuleHolder （一个 shared_ptr 包装器）
// 参见 https://github.com/pytorch/pytorch/blob/master/torch/csrc/api/include/torch/nn/pimpl.h
